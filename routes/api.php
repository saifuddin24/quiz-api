...
Route::prefix( '/user' )->group( function (  ){
    ...
    Route::get( '/registration-data/{type}', 'ApiAuth\UserController@getUserType' );
    Route::post( '/create', 'ApiAuth\UserController@store' );

    Route::put( '/edit', 'ApiAuth\UserController@store' )->middleware('auth:api');

    Route::prefix( '/password' )->group( function ( ) {

        Route::post( '/reset-request', 'ApiAuth\ForgotPasswordController@sendResetLinkEmail' )
            ->middleware( 'throttle:20,1' );

        Route::patch( '/reset', 'ApiAuth\ResetPasswordController@reset' );

        Route::patch( '/change', 'ApiAuth\ResetPasswordController@change' )
